              ...
              <div className="lg:w-9/12 xl:w-8/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mx-auto">
                <figure className="!mb-10">
                  <Image
                    ...
                    srcSet="/assets/img/image-error.png 2x"
                    alt="image"
                    width={800}
                    height={316}
                    src="/assets/img/image-error.png"
                  />
                </figure>
              </div>
              {/* /column */}
              <div className="lg:w-8/12 xl:w-7/12 xxl:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mx-auto !text-center">
                <h1 className="!mb-3">¡Whoops! Página no encontrada.</h1>
                <p className="lead !leading-[1.65] text-[0.9rem] font-medium !mb-7 md:!px-14 lg:!px-5 xl:!px-7">
                  La página que estás buscando no está disponible o ha sido movida. Intenta otra página o ve a la página principal con el botón de abajo.
                </p>
                <Link
                  href={`/`}
