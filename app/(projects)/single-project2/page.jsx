...
export const metadata = {
  title:
    "Single Project 02 || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function SingleProjectPage2() {
  return (
    <>
      <div className="grow shrink-0">
        <Header32
          parentClass="relative wrapper bg-soft-primary !bg-[rgba(254,254,254)]"
          navClass="navbar navbar-expand-lg center-nav transparent navbar-light xl:pt-[.3rem] lg:pt-[.3rem]"
        />
        <section className="wrapper !bg-[rgba(254,254,254)]">
          <div className="container pt-10 pb-9 xl:pt-[4.5rem] lg:pt-[4.5rem] md:pt-[4.5rem] xl:pb-[3rem] lg:pb-[3rem] md:pb-[3rem] !text-center">
