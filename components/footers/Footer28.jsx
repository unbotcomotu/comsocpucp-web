...
export default function Footer28() {
  return (
    <footer className="!bg-[#edf2fc]">
      <div className="container pt-28 xl:pt-36 lg:pt-36 md:pt-36 pb-[4.5rem] xl:pb-24 lg:pb-24 md:pb-24">
        <div className="flex flex-wrap mx-[-15px] !mt-[-30px] xl:!mt-0 lg:!mt-0">
          ...
          <div className="md:w-4/12 xl:w-3/12 lg:w-3/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!mt-0 lg:!mt-0 !mt-[30px]">
            <div className="widget">
              <h4 className="widget-title !mb-3 !text-[0.95rem] !leading-[1.45]">
                Get in Touch
              </h4>
