...
export default function Header29() {
  return (
    <header className="relative wrapper !bg-[#ffffff]">
      <div className="bg-[rgba(63,120,224)] !text-white font-bold text-[.75rem] !mb-2">
        <div className="container py-1 xl:!flex lg:!flex md:!flex xl:!flex-row lg:!flex-row md:!flex-row">
