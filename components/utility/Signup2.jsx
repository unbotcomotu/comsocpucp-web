    ...
    <section className="wrapper !bg-[#ffffff]">
      <div className="container !pb-[4.5rem] xl:!pb-24 lg:!pb-24 md:!pb-24">
        <div className="flex flex-wrap mx-[-15px]">
          <div className="!mt-[-9rem] w-full flex-[1_0_0%] !px-[15px] max-w-full !relative z-[3]">
            <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
              <div className="flex flex-wrap mx-0 !text-center">
                <div
                  className="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] max-w-full image-wrapper bg-image rounded-t-[0.4rem] rounded-lg-start max-sm:!hidden !block bg-cover bg-[center_center] bg-no-repeat !bg-scroll md:min-h-[25rem]"
                  style={{ backgroundImage: "url(/assets/img/photos/tm3.jpg)" }}
                />
                {/*/column */}
                  ...
                  <div className="!p-10 md:!p-12 xl:!p-[4rem] lg:!p-[4rem]">
                    ...
                    >
                      ...
                      <div className="form-floating !relative password-field !mb-4">
                        ...
                        >
                          <i
                            className={`uil uil-eye${showPass ? "-slash" : ""}`}
                          />
                        </span>
                        <label
                    ...
                    <p className="!mb-0">
                      ...
                      <Link href={`/signin2`} className="hover">
                        Sign in
                      </Link>
                    </p>
